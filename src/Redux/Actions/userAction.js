...
export const userRegisterAction = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("http://localhost:8000/api/user/register", userData);
...
export const loadUserAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("http://localhost:8000/api/user/getloggeduser");
...
export const userPasswordUpdateAction = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put("http://localhost:8000/api/user/changePassword", userData);
...
export const restPasswordSendEmailAction = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("http://localhost:8000/api/user/send-reset-password-email", {
      email,
    });
...
export const getAllUsersAdminAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("http://localhost:8000/api/user/admin/user");
...
export const deleteUserAdminAction = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`http://localhost:8000/api/user/admin/user/${userId}`);
...
export const adminUpdateUserAction = (userId, UserRole) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`http://localhost:8000/api/user/admin/user/${userId}`, {
      UserRole,
    });
