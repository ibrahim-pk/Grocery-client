      ...
      <footer>
        <section className="footer">
            ...
            <div className="box">
              ...
              <div className="share">
                <Link>
                  <i
                    onClick={() => {
                      window.location = `https://wa.me?text=Say Hello..!!`;
                    }}
                  >
                    {<IoLogoWhatsapp />}
                  </i>
                ...
                <a href="https://www.facebook.com/rasel.raj.58910">
          ...
          <div className="credit">
            Created By <span>Rayhanur Rahman Rasel </span> | All Right Reserved
          </div>
        </section>
      </footer>
    </>
