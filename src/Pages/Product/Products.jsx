              ...
              >
                ...
                <div className="price-filter">
                  ...
                  <select onChange={(e) => setPrice(e.target.value)}>
                    ...
                    <option value="0-20">tk. 0 - tk. 20/Kg</option>
                    <option value="20-40">tk. 20 - tk. 40/Kg</option>
                    <option value="40-60">tk. 40 - tk. 60/Kg</option>
                    <option value="60-80">tk. 60 - tk. 80/Kg</option>
                    <option value="80-100">tk. 80 - tk. 100/Kg</option>
                    <option value="100-120">tk. 100 - tk. 120/Kg</option>
                  </select>
                </div>
                      ...
                      products.map((product) => {
                        return (
                          <div className="product-cart" key={product._id}>
                            ...
                            <h2>{product.name}</h2>
                            <div className="price">tk. {product.rate}/Kg</div>
